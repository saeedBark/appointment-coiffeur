...
<head>
<meta charset="UTF-8">
<title>Coiffeur Login Page</title>
		...
		<div class="container mt-2 p-5">
			<div class="row">
				<div class="col-md-6 p-6">
					<img  src="img/br1.jpg" width="100%" height="400px">
				</div>
					
				<div class="col-md-6  p-5">
					<div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
						<div class="card-header">
							<p class="fs-4 text-center">Coiffeure Login</p>
						</div>
						<div class="card-body">
							...
							<form action="coiffeureLogin" method="post">
								<div class="mb-3">
