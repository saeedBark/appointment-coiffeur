...
<div class="container p-5">
    <p class="text-center fs-3">Les Salon dans Tevrak Zeina</p>   
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-2">
            ...
            <div class="card paint-card " data-bs-toggle="modal"
                ...
                <div class="card-body text-center">
                    <i class="fa-solid fa-shop fa-3x"></i></i><br>
                    <p class="fs-4 text-center">
                        Salon <br>El Wefa
                    </p>
                </div>
...
<div class="modal fade" id="example4" tabindex="-1"
     aria-labelledby="exampleModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="card-body">
          ...
          <form class="row g-3" action="addAppointement" method="post">
            ...
            <div class="col-md-6">
              ...
              <option value="">Choisir Service</option>
               <%
                ServiceDao dao8 = new ServiceDao(DBConnect.getConn());
                List<Service> list8 = dao8.geAllServ();
                for (Service s : list8) {
                %>
                <option><%=s.getServiceName()%></option>
               <%
            ...
            <div class="col-md-6">
              ...
              EmployeDao dao9 = new EmployeDao(DBConnect.getConn());
              List<Employe> list9 = dao9.getAllEmploye();
              for(Employe e : list9){
             %>
            	<option value="<%=e.getId() %>"><%=e.getName() %> (<%=e.getSalon()%>) </option>
...
<div class="modal fade" id="example5" tabindex="-1"
     aria-labelledby="exampleModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="card-body">
          ...
          <form class="row g-3" action="addAppointement" method="post">
            ...
            <div class="col-md-6">
              ...
              <option value="">Choisir Service</option>
               <%
                ServiceDao dao10 = new ServiceDao(DBConnect.getConn());
                List<Service> list10 = dao10.geAllServ();
                for (Service s : list10) {
                %>
                <option><%=s.getServiceName()%></option>
               <%
                 }
            ...
            <div class="col-md-6">
              ...
              EmployeDao dao11 = new EmployeDao(DBConnect.getConn());
              List<Employe> list11 = dao11.getAllEmploye();
              for(Employe e : list11){
             %>
            	<option value="<%=e.getId() %>"><%=e.getName() %> (<%=e.getSalon()%>) </option>
